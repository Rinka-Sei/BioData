...
function gatherData() {
    ...
    return {
        firstName, lastName, dob, gender, nationality, email, phone, address, now
    };
}
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const inputs = document.querySelectorAll('#bioDataForm input, #bioDataForm textarea, #bioDataForm select');
